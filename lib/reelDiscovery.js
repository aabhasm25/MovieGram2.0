...
export function assessCandidateRelevance(candidate = {}, item = {}) {
  ...
  const accepted = Boolean(tmdbExact || trustedSource || (exactPhrase && exactTitleIsSpecific) || titleKeywordMatch) && matchScore >= 35;
  return {
    accepted,
    match_score: matchScore,
    rejection_reason: accepted ? "" : "Low title/source relevance"
  };
}
